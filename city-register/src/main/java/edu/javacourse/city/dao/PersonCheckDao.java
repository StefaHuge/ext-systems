...
public class PersonCheckDao {
    ...
    private static final String SQL_REQUEST =
            "select temporal from cr_address_person ap " +
                    ...
                    "and upper(p.sur_name COLLATE \"ru.RU\") = upper(? COLLATE \"ru.RU\")  " +
                    "and upper(p.given_name COLLATE \"ru.RU\") = upper(? COLLATE \"ru.RU\")   " +
                    "and upper(patronymic COLLATE \"ru.RU\") = upper(? COLLATE \"ru.RU\")  " +
                    "and p.date_of_birth = ? " +
                    "and a.street_code = ?  " +
                    "and upper(a.building COLLATE \"ru.RU\") = upper(? COLLATE \"ru.RU\")  ";
    ...
    public PersonResponse checkPerson(PersonRequest request) throws PersonCheckException {
        ...
        if (request.getExtension() != null) {
            sql += "and upper(a.extension COLLATE \"ru.RU\") = upper(? COLLATE \"ru.RU\")  ";
        } else {
            sql += "and a.extension is null ";
        }
        if (request.getApartment() != null) {
            sql += "and upper(a.apartment COLLATE \"ru.RU\") = upper(? COLLATE \"ru.RU\")";
        } else {
