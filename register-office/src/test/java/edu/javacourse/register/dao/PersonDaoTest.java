...
//                System.out.println("Birth Cert: " + ((PersonMale)p)
//                        .getBirthCertificates().size());
//                System.out.println("Marriage Cert: " + ((PersonMale)p)
//                        .getMarriageCertificates().size());
//            } else {
//                System.out.println("Birth Cert: " + ((PersonFemale)p)
//                        .getBirthCertificates().size());
//                System.out.println("Marriage Cert: " + ((PersonFemale)p)
//                        .getMarriageCertificates().size());
//            }
//        });
    }
